...
//Can use a post also
String GET = "GET /temporaryUpload.php?temporary=";
...
bool updateTemp(String tenmpF, String humid){
  ...
  if(Serial.find("Error")){
    return false;
      Serial.begin(9600);   
      Serial.println("update temperature failed");
  }
